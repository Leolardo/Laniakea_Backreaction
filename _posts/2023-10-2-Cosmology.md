...
The reconstructed radial peculiar velocity field inside Laniakea, computed with respect to the centre of our best fit ellipsoid: <img  width="80%" src="{{ site.baseurl }}/_includes/Sn1aH0_corr_Radec.png" border="500">
